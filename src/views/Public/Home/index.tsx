  ...
  return (
    <>
      <Box backgroundColor="gray.200">
        <Header />
        {isMobile ? <TopLayoutMobile /> : ""}
        {isDesktop ? <TopLayoutDesktop /> : ""}
        {isTablet ? <TopLayoutTablet /> : ""}
        ...
        >
          ...
          <Box marginTop="50px;">
            ...
            >
              {isDesktop ? (
                <>
                  Faz um bem! propõe-se, como uma plataforma virtual interativa,
                  <br /> a
                  <strong> interligar doadores e receptores de recursos</strong>
                  , centralizando
                  <br />
                  as necessidades de instituições e organizações sociais de
                  <br /> Santa Maria. Traz, portanto,{" "}
                  <strong>
                    informações sobre campanhas
                    <br /> que estão acontecendo{" "}
                  </strong>
                ...
                <>
                  ...
                  a
                  <strong> interligar doadores e receptores de recursos</strong>
                  , centralizando as necessidades de instituições e organizações
                  sociais de Santa Maria. Traz, portanto,{" "}
                  <strong>
                    informações sobre campanhas que estão acontecendo{" "}
                  </strong>
        ...
        <>
          ...
          >
            ...
            <Collapse
              startingHeight={isMobile ? 850 : 700}
              in={show}
              transition={{ enter: { duration: 2.5 }, exit: { duration: 2.5 } }}
            >
              <SimpleGrid
                columns={4}
                  ...
                  <Box key={institute.idUser}>
                    <Box className={instituteStyle["card"]}>
                      ...
                      <Box className={instituteStyle["card-title"]}>
                        <Text color="white" margin="5px 0" fontSize="18px">
                          {institute.name}
                        </Text>
                      </Box>
                      <Box className={instituteStyle["icons"]}>
                        ...
                        >
                          <IconButton
                            ...
                            onClick={(e) =>
                              openRoute(`/institute/${institute.idUser}`)
                            }
                          />
                        </Tooltip>
                      </Box>
